            ...
            <form method="post" action="adminpanel-vacancy-add-update.action">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="vacancy_add_description" required class="form-control" name="vacancy.description"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Skills: </label>
                        <textarea id="vacancy_add_skills" required class="form-control" name="vacancy.skills"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Email: </label>
                        <input id="vacancy_add_email" type="email" required class="form-control" name="vacancy.email">
                    </div>
                    <div class="form-group">
                        <label>Phone: </label>
