<div class="modal vacancy_edit_modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">.
            <form method="post" action="adminpanel-vacancy-add-update.action">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Company: </label>
                        <select required class="form-control" name="vacancy.company.id">
                            <s:iterator value="companiesList" var="category">
                                <option <s:if test="%{#id == #companyId}">selected</s:if>
                                        value="<s:property value="id"></s:property>">
                                    <s:property value="companyName"></s:property>
                                </option>
                            </s:iterator>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea id="vacancy_edit_description" required class="form-control" name="vacancy.description"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Email: </label>
                        <input id="vacancy_edit_email" type="email" required class="form-control" name="vacancy.email">
                    </div>
                    <div class="form-group">
                        <label>Phone: </label>
                    ...
                    <div class="form-group">
                        <label>Skills: </label>
                        <textarea id="vacancy_edit_skills" required class="form-control" name="vacancy.skills"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Salary: </label>
