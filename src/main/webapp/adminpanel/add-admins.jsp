                ...
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <form method="post" action="adminpanel-newadmin.action">
                        <div class="form-group">
                            <label>Login: </label>
                            <input type="text" required class="form-control" name="user.login"> <!--pattern="^[A-Za-z0-9_]{5,30}$"-->
                        </div>
                        <div class="form-group">
                            <label>Email: </label>
                            <input type="email" required class="form-control" name="user.email">
                        </div>
                        <div class="form-group">
                            <label>Password: </label>
                            <input type="password" required class="form-control" name="user.password"> <!--pattern="^[A-Za-z0-9@#$%*]{8,60}$">-->
                        </div>
                        <div class="form-group">
                            <label>Repeat password: </label>
                            <input type="password" required class="form-control" name="repeatPassword"> <!--pattern="^[A-Za-z0-9@#$%*]{8,60}$">-->
                        </div>
                        </br>
