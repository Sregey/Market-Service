					...
					<div class="well">
						<ul class="nav nav-tabs">
							...
							<li data-id="2" class="tab">
                                <a href="#ascompany" data-toggle="tab" >
                                    Sign up as company
                                </a>
                            </li>
						</ul>
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane in" id="ascustomer">
								<form class="form-horizontal" action='signup-as-customer.action' method="POST">
									<fieldset>
										...
										<div class="form-group">
											<input class="form-control" placeholder="Birth date" name="birthdate" type="date" value="">
										</div>
										<div class="form-group">
											<input class="form-control" placeholder="Address" name="address" type="text" value="">
										</div>
										<div class="form-group">
											<textarea class="form-control" placeholder="Skills" name="skills" type="text" value=""></textarea>
										</div>
										<div class="form-group">
							...
							<div class="tab-pane" id="ascompany">
								<form class="form-horizontal" action='signup-as-company.action' method="POST">
									<fieldset>
										&nbsp;
										<div id="legend">
