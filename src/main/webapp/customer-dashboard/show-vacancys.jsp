...
<div id="wrapper">
    ...
    <%@include file='vacancy-feedback.jsp'%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <a href="/generateVacancysXLS.action">Generate XLS</a>
                            &middot;
                            <a href="/generateVacancysCSV.action">Generate CSV</a>
                            <p>Vacancys list:</p>
...
<script>
    function feedback(instance)
    {
        var id = $(instance).attr('id_instance');
        $('#vacancy_feedback_id').val(id);
        $('.vacancy_feedback_modal').modal();
    }
</script>
